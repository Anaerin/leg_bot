...
const Op = module.exports.Op = Sequelize.Op;
...
//Barks are short replies to basic commands, like NPC barks.
...
//LastSeen - tracks when the last time someone spoke
var LastSeen = module.exports.LastSeen = sequelize.define('LastSeen', {
	...
	whereSeen: Sequelize.STRING(64)
}, options);

//Quotes are memorable sayings.
var Quote = module.exports.Quote= sequelize.define('Quotes', {
    quote: Sequelize.STRING(512),
    author: Sequelize.STRING(25),
    when: Sequelize.DATEONLY,
    game: Sequelize.STRING(255),
    active: {
        type: Sequelize.BOOLEAN,
        defaultValue: true
...
Quote.belongsTo(Channel);

var Settings = module.exports.Settings = sequelize.define('Settings', {
